        ...
        >
            ...
            <div className="flex flex-col flex-grow p-5 space-y-4">
                <div className="space-y-1">
                    <span className="text-[11px] font-bold text-blue-600 uppercase tracking-wider">{product.category || 'Verified BM'}</span>
                ...
                <div className="mt-auto pt-2">
                    <div className="rounded-xl bg-[#FFF5F5] border border-[#FFE0E0] p-4 mb-4">
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="text-green-600 text-xs font-bold">Save ${(product.oldPrice && product.price ? (parseFloat(product.oldPrice) - parseFloat(product.price)).toFixed(2) : '200.00')}</span>
                        </div>
